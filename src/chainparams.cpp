...
{
    const char* pszTimestamp = "Block #594365:0000000000000000000babb522b70ddeb309854a2bef8b546d6d597ce5596a92";
    const CScript genesisOutputScript = CScript() << ParseHex("04399895adfff7710a92a1b5ae33c69c39a4134936e6a80ef15ccd8d79fc47406168afd9328e870342197b1c17000927196f0535791ee2369e3139b2fae360269d") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1568505601; // Sep 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1600127999; // Sep 14th, 2020

        // Deployment of DIP0001
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 1568505601; // Sep 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 1600127999; // Sep 14th, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nThreshold = 3226; // 80% of 4032

        // Deployment of BIP147
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 1568505601; // Sep 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = 1600127999; // Sep 14th, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nThreshold = 3226; // 80% of 4032

        // Deployment of DIP0003
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 1568505601; // Sep 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nTimeout = 1600127999; // Sep 14th, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nWindowSize = 4032;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nThreshold = 3226; // 80% of 4032

        // Deployment of DIP0008
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 1568505601; // Sep 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 1600127999; // Sep 14th, 2020
        ...
        genesis = CreateGenesisBlock(1568219440UL, 809327UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("00000a29ef12c56d995805ee7fe2bd78f52dcca786e0f207100a20a455a1912f"));
        assert(genesis.hashMerkleRoot == uint256S("c1e95c68ed5978549e14a4788762d30f783057c80a597b33fd09374a8d30e688"));


        vSeeds.push_back(CDNSSeedData("dashdot.io", "dotseed.dashdot.io"));
        ...
        vSporkAddresses = {"EQC49YiVPzMUfiqsiMsTWmohhXV2bS2fcX"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000a29ef12c56d995805ee7fe2bd78f52dcca786e0f207100a20a455a1912f"))
            (160, uint256S("0x00000000006baa23a725155b5e504a6cf7b2769c39040f71f246068646d878af"))
        };

        chainTxData = ChainTxData{
            1568379080, // * UNIX timestamp of last known number of transactions (Block 160)
            160,   // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1568226320UL, 3838095UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000025db8eb11b1a04f9412a81a69e94c1fdce8ba5eb3546e360d0af712d5a4"));
        assert(genesis.hashMerkleRoot == uint256S("0xc1e95c68ed5978549e14a4788762d30f783057c80a597b33fd09374a8d30e688"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x0000025db8eb11b1a04f9412a81a69e94c1fdce8ba5eb3546e360d0af712d5a4"))
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1568226320UL, 3838095UL, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000025db8eb11b1a04f9412a81a69e94c1fdce8ba5eb3546e360d0af712d5a4"));
        assert(genesis.hashMerkleRoot == uint256S("0xc1e95c68ed5978549e14a4788762d30f783057c80a597b33fd09374a8d30e688"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1568226321UL, 0UL, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x56f4ba0acc1e0dc7f7f1ad5b1ec9a6c6d197564d1ade2f29e9f1c30700eac3f1"));
        assert(genesis.hashMerkleRoot == uint256S("0xc1e95c68ed5978549e14a4788762d30f783057c80a597b33fd09374a8d30e688"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x56f4ba0acc1e0dc7f7f1ad5b1ec9a6c6d197564d1ade2f29e9f1c30700eac3f1"))
        };
