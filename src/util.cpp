...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\DotCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\DotCore
    // Mac: ~/Library/Application Support/DotCore
    // Unix: ~/.dotcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "DotCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/DotCore";
#else
    // Unix
    return pathRet / ".dotcore";
#endif
#endif
}
